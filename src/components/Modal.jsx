...
export default function Modal() {
  ...
  <button className="w-full sm:w-auto flex flex-col items-center text-sm text-center uppercase transition-all duration-150 ease-linear hover:shadow-lg focus:outline-none hover:bg-[#088269]" type="button" onClick={() => setShowModal(true)}>
  ...
  {showModal ? (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
        <div className="relative max-w-3xl mx-auto my-6 sm:max-w-2xl w-[500px]">
